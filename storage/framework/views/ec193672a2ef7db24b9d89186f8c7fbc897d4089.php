            ...
            <table style="margin-bottom: 30px;max-width:400px;">
                <tbody>
                    ...
                    <tr>
                        <th width="80px" style="vertical-align:top">                        
                            <p class="text-left mb-0" style="font-weight:100;">
                                <b>Used Leave Days: </b><?php echo e($user->used_leave ?? 0); ?>
                    ...
                    <tr>
                        <th width="80px" style="vertical-align:top">                        
                            ...
                            <?php $cal_leave = (isset($annualleavedetails) && $annualleavedetails['totalLeaveDays']>0 )?$annualleavedetails['totalLeaveDays']:0; 
                                ...
                                <b>Leave Balance Days: </b><?php echo e($bal_leave ?? 0); ?>
                    ...
                    <tr>
                        <th width="80px" style="vertical-align:top">                        
                            ...
                            $bal = 0;
                                                ...
                                                ?>
                                <b>Balance Amount: </b>KWD <?php echo e(number_format($bal,2)); ?>
            ...
            <table class="custom-table" style="margin-bottom: 30px;max-width:400px;border:1px solid #dee2e6;">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>                        
                            <p>
                                <b>Total Overtime: </b>KWD <?php echo e(number_format($total_overtime_salary, 2)); ?>
                    ...
                    <tr>
                        <td>                        
                            <p>
                                <b>Total Annual Leave: </b>KWD <?php echo e(number_format(_calculate_salary_by_days($e_sal,$bal_leave ?? 0),2)); ?>
                    ...
                    <tr>
                        <td>                        
                            <p>
                                <b>Total Public Holiday: </b>KWD <?php echo e(number_format($bal,2)); ?>
...
<?php //exit; ?><?php /**PATH C:\wamp64_new\www\hrm\resources\views/edbr/fnf_pdf.blade.php ENDPATH**/ ?>