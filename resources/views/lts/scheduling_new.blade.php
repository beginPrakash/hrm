                            ...
                            <div class="table-responsive">
                                <table class="table table-striped custom-table datatable">
                                    ...
                                    <tbody>
                                        <?php
                                        if(isset($scheduling))
                                        { //echo '<pre>';print_r($scheduling);
                                            $image = "assets/img/profiles/avatar-09.jpg";
                                            foreach($scheduling as $shkey => $sh)
                                            {  //echo 'hi';echo '<pre>';print_r($sh);
                                                if($sh->profile != Null)
                                                {
                                                ...
                                                <tr>
                                                    <td>
                                                        <h2 class="table-avatar">
                                                            ...
                                                            <a href="profile.php"><?php echo $sh->first_name; ?> <?php echo (isset($sh->last_name))?$sh->last_name:''; ?> <span><em><?php echo (isset($sh->employee_designation->name))?': '.$sh->employee_designation->name:''; ?></em></span></a>
                                                        </h2>
                                                    </td>
                                                    <td>
                                                        <?php
                                                        ...
                                                        // $tday = date('d/m/Y');
                                                        $emloyeeScheduleToday = App\Models\Scheduling::where('employee', $sh->user_id)->where('shift_on', $tday)->where('status', 'active')->first();
                                                        ...
                                                        ?>
                                                            <div class="user-add-shedule-list">
                                                                    <a href="#" data-bs-toggle="modal" data-bs-target="#add_schedule_user0<?php echo $shkey; ?>">
                                                                    <span><i class="fa fa-plus"></i></span>
                                                                    </a>
                                                                </div>
                                                                <div id="add_schedule_user0<?php echo $shkey; ?>" class="modal custom-modal fade" role="dialog">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select class="select form-control" name="department_addschedule" id="department_addschedules">
                                                    <option value="0">Select Department</option>
                                                    <?php foreach ($department as $dept) {?>
                                                        <option value="<?php echo $dept->id?>" <?php echo $sh->department==$dept->id?'selected':'disabled'; ?>><?php echo $dept->name?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="" value="<?php echo $sh->first_name.' '.$sh->last_name; ?>" readonly>
                                                <input type="hidden" name="employee_addschedule" value="<?php echo $sh->user_id; ?>">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                        ...
                                        <button class="btn btn-primary submit-btn">Submit</button>
                                                    ...
                                                    { ?>
                                                        <td>
                                                            ...
                                                            $emloyeeAttendanceDays = App\Models\Scheduling::where('employee', $sh->user_id)->where('shift_on', $days)->first();
                                                            ...
                                                            ?>
                                                                <div class="user-add-shedule-list">
                                                                    <a href="#" data-bs-toggle="modal" data-bs-target="#add_schedule_user<?php echo $i.$shkey; ?>">
                                                                    <span><i class="fa fa-plus"></i></span>
                                                                    </a>
                                                                </div>
                                                                <div id="add_schedule_user<?php echo $i.$shkey; ?>" class="modal custom-modal fade" role="dialog">
                    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Add Schedule</h5>
                                ...
                                <form id="add_schedule_form" action="/scheduleInsert" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label class="col-form-label">Department <span class="text-danger">*</span></label>
                                                <select class="select form-control" name="department_addschedule" id="department_addschedulex">
                                                    <option value="0">Select Department</option>
                                                    <?php foreach ($department as $dept) {?>
                                                        <option value="<?php echo $dept->id?>" <?php echo  $sh->department==$dept->id?'selected':'disabled'; ?>><?php echo $dept->name?></option>
                                                    <?php } ?>
