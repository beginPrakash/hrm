...
<div class="page-wrapper">
    ...
    <?php echo $__env->make('flash-message', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>  
        ...
        <!-- /Page Header -->
        <!-- Search Filter -->
        <form method="post" action="<?php echo e(route('civil_report')); ?>">
                    <?php echo csrf_field(); ?>
                        ...
                        <table class="table table-striped custom-table datatablex" id="datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e((isset($data->employee_details) && !empty($data->employee_details->expi_c_id)) ? date('d, M Y', strtotime($data->employee_details->expi_c_id)) : ''); ?></td>
                                    ...
                                    <td>KWD <?php echo e(number_format($civil_cost,2) ?? 0); ?></td>
...
<?php /**PATH C:\wamp64_new\www\hrm\resources\views/reports/index.blade.php ENDPATH**/ ?>