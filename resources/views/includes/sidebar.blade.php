        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <ul class="sidebar-vertical"> 
                ...
                <li class="submenu">
                    ...
                    @endphp
                    <a href="#" class="{{  $mangae_edbr ? 'active-ho-jao' : ''}}"><i class="la la-user"></i> <span> Manage EDBR</span> <span class="menu-arrow"></span></a>
                ...
                <li class="menu-title"> 
                    <div class="form-check form-switch">
                        <span>Show Analytics</span><input class="form-check-input" type="checkbox" role="switch" data-url="{{route('settings.changeanalytic_status')}}" id="analytic_btn" {{(!empty($get_analytics)) ? 'checked' : ''}}>
                    </div>
                </li>     
                @endif
            </ul>
