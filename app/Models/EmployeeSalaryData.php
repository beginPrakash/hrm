...
class EmployeeSalaryData extends Model
{
    ...
    protected $fillable = [
		'employee_id' ,'branch_id','branch_name' ,'name','position','company_id','company_name','license','total_schedule_hours','total_fs_hours','hourly_salary','day_salary','basic_salary','salary','travel_allowence','house_allowence','position_allowence','phone_allowence','other_allowence','deduction','total_earning','es_year','es_month','dates_between','type' 
    ];
