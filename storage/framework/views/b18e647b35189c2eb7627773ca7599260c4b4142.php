        ...
        <div class="card">
            <div class="card-body">
                <form action="" method="post" id="otapprove">
                    ...
                    Scheduled Shift <br>
                        <span style="text-indent: 50px;">Start Time : <?php echo $shiftScheduleStart; ?></span><br>
                        <span style="text-indent: 50px;">End Time : <?php echo $shiftScheduleEnd; ?></span><br>
                        <span style="text-indent: 50px;">Break Time : <?php echo $breaktime; ?>Mins</span>
                        <input type="hidden" name="break_time_val" id="break_time_val" value="<?php echo $breaktime; ?>">
                        <input type="hidden" name="normal_wt_val" id="normal_wt_val" value="<?php echo $workingHours; ?>">
                        <br><br>
                    Punch Timings <br>
                    <div class="input-group timex timepickerx">
                        <input type="hidden" name="schd_start_date" id="schd_start_date" value="<?php if(!empty($start)): ?> <?php echo e(date('Y-m-d',strtotime($start))); ?> <?php endif; ?>">
                        Start Time (<?php echo e(date('d F, Y',strtotime($start))); ?>): <input type="time" class="form-control addsched" name="start_time" id="start_time" value="<?php $date = date("H:i", strtotime($scheduleStart)); echo $date; ?>"><span class="input-group-text"><i class="fa fa-clock-o"></i></span><br>
                    </div>
                    <div class="input-group timex timepickerx">
                        <input type="hidden" name="schd_end_date" id="schd_end_date" value="<?php if(!empty($last)): ?> <?php echo e(date('Y-m-d',strtotime($last))); ?> <?php endif; ?>">
                        End Time (<?php echo e(date('d F, Y',strtotime($last))); ?>): <input type="time" class="form-control addsched" name="end_time" id="end_time" value="<?php $date = date("H:i", strtotime($scheduleEnd)); echo $date; ?>"><span class="input-group-text"><i class="fa fa-clock-o"></i></span>
                    </div>
                        <br>
                    ...
                    Over Time : <span id="ottime"><?php echo ($emloyeeAttendance[0]['ottime']!='')?$emloyeeAttendance[0]['ottime']:$finalOt; ?><?php //echo $ot; ?></span>hrs
                    <input type="hidden" name="ottime_val" id="ottime_val" value="<?php echo ($emloyeeAttendance[0]['ottime']!='')?$emloyeeAttendance[0]['ottime']:$finalOt; ?>">
                    <br>
...
</script><?php /**PATH C:\wamp64_new\www\hrm\resources\views/lts/attendancePopup.blade.php ENDPATH**/ ?>