...
<div class="page-wrapper">
    ...
    <?php echo $__env->make('flash-message', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>  
        ...
        <!-- /Page Header -->
        <!-- Search Filter -->
        <form method="post" action="<?php echo e(route('transport_report')); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group form-focus select-focus">
                        <select class="selectwith_search" name="reg_type">
                            ...
                            <?php foreach ($reg_type as $key => $val) {?>
                                <option value="<?php echo e($key); ?>" <?php echo (isset($search['reg_type']) && $search['reg_type']==$key)?'selected':''; ?>><?php echo e($val); ?></option>
                            <?php } ?>
                        </select>
                        ...
                        <table class="table table-striped custom-table datatablex" id="datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e((isset($data->trans_detail) && !empty($data->trans_detail)) ? $data->trans_detail->car_name : ''); ?></td>
                                    <td><?php echo e((isset($data->trans_detail) && !empty($data->trans_detail)) ? $data->trans_detail->license_no : ''); ?></td>
                                    <td><?php echo e((isset($data->regis_type) && !empty($data->regis_type)) ? $data->regis_type->name : ''); ?></td>
                                    <td><?php echo e($data->doc_name ?? ''); ?></td>
                                    <td><?php echo e($data->doc_number ?? ''); ?></td>
                                    <td><?php echo e((isset($data->trans_detail->com_detail) && !empty($data->trans_detail->com_detail)) ? $data->trans_detail->com_detail->name : ''); ?></td>
                                    <td><?php echo e((isset($data->trans_detail->subcom_detail) && !empty($data->trans_detail->subcom_detail)) ? $data->trans_detail->subcom_detail->name : ''); ?></td>
                                    <td>KWD <?php echo e(number_format($trans_cost,2) ?? 0); ?></td>
...
<?php /**PATH C:\wamp64_new\www\hrm\resources\views/reports/transport.blade.php ENDPATH**/ ?>