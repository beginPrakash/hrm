 ...
 <!-- Page Wrapper -->
            <div class="page-wrapper">
                                        ...
                                        if(isset($uroles_data))
                                        {
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="{{'/employeeProfileUpdate?id='.$data->employee_id }}">{{(isset($data->employee) && !empty($data->employee)) ? $data->employee->full_name : ''}}</a></td>
                                                    <td>{{(isset($data->roles_detail) && !empty($data->roles_detail)) ? $data->roles_detail->title : ''}}</td>
                                                    <td>
                                                        @if(isset($company_name) && count($company_name) > 0)
                                                    ...
                                                    <td>
                                                        <a href="#" data-toggle="modal" data-target="#add_leave" data-id="{{$data->id}}" class="action-icon edit_hierarchy"><i class="fa fa-pencil"></i></a>
                                                        <a href="#" data-toggle="modal" data-target="#delete_user_roles" data-id="{{$data->id}}" class="delete_user_roles"><i class="fa fa-trash-o m-r-5" ></i></a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
                ...
                <div id="add_leave" class="modal custom-modal fade modal_div" role="dialog">
                    @include('roles_permission/user_roles_modal')
                </div>
                <!-- /Add Role Modal -->
                        ...
                        <div class="modal-content">
                            <div class="modal-body">
                                ...
                                <div class="modal-btn delete-action">
                                    <div class="row">
                                        <div class="col-6">
                                            <form action="{{route('user_roles.delete')}}" method="post">
                                                @csrf
