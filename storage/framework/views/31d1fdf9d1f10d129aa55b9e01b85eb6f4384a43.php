                        ...
                        <div class="row filter-row">
                            ...
                            <div class="col-sm-6 col-md-2">  
                                <div class="form-group form-focus focused">
                                    <div class="cal-icon">
                                        <input class="form-control floating datetimepicker" type="text" name="from_date" value="<?php echo (isset($search['from_date']))?$search['from_date']:date('d-m-Y', strtotime($startDate)); ?>">
                                    </div>
...
<script>    
    $(document).ready(function() {
        $('.shift_addschedule').on('change', function() {
            ...
            if(parseInt(shiftId) <= 2)
            { 
                $('#timedivadd,#timedivedit').css('display', 'none');
            }
            else if(parseInt(shiftId) > 2){ 
...
</script><?php /**PATH C:\xampp81\htdocs\hrmumair\resources\views/lts/scheduling.blade.php ENDPATH**/ ?>