...
<div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="<?php echo e(route('upselling_heading.store')); ?>" method="post" id="addForm">
            <?php echo csrf_field(); ?>
...
</div><?php /**PATH C:\wamp64_new\www\hrm\resources\views/up_selling_management/tracking_heading_modal.blade.php ENDPATH**/ ?>