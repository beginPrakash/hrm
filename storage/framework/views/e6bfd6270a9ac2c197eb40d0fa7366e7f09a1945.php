                    ...
                    <?php if(isset($data_list) && count($data_list) > 0): ?>
                        ...
                        <?php $__currentLoopData = $data_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><?php echo e((isset($data->trans_detail) && !empty($data->trans_detail)) ? $data->trans_detail->car_name : ''); ?></p>
                                </td>
                                <td>
                                    <p><?php echo e((isset($data->trans_detail) && !empty($data->trans_detail)) ? $data->trans_detail->license_no : ''); ?></p>
                                </td>
                                <td>
                                    <p><?php echo e((isset($data->regis_type) && !empty($data->regis_type)) ? $data->regis_type->name : ''); ?></p> 
                                </td>
                                <td>
                                    <p><?php echo e($data->doc_name ?? ''); ?></p>
                                </td>
                                <td>
                                    <p><?php echo e($data->doc_number ?? ''); ?></p>
                                </td>
                                <td>
                                    <p><?php echo e((isset($data->trans_detail->com_detail) && !empty($data->trans_detail->com_detail)) ? $data->trans_detail->com_detail->name : ''); ?></p>
                                </td>
                                <td>
                                    <p><?php echo e((isset($data->trans_detail->subcom_detail) && !empty($data->trans_detail->subcom_detail)) ? $data->trans_detail->subcom_detail->name : ''); ?></p>
                                </td>
                                <td>
                                    <p>KWD <?php echo e(number_format($trans_cost,2) ?? 0); ?></p>
                                </td>
                                <td>
                                    <p><?php echo e(date('d, M Y', strtotime($data->expiry_date))); ?></p>
                                </td>
                                <td>
...
<?php //exit; ?><?php /**PATH C:\wamp64_new\www\hrm\resources\views/reports/transport_report_pdf.blade.php ENDPATH**/ ?>