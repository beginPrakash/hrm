                ...
                <?php if(isset($emp_branch_data) && count($emp_branch_data) > 0): ?>
                    <?php $__currentLoopData = $emp_branch_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bkey => $bval): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <?php if(isset($emp_company_data) && count($emp_company_data) > 0): ?>
                                <?php $__currentLoopData = $emp_company_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ckey => $cval): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <td><?php echo e(number_format(calcualte_ot_total_earning_by_month_company($month,$year,$cval->company_id,$bval->id,'cash'), 2)); ?></td>
                                    <td><?php echo e(calcualte_ot_total_earning_by_month_company($month,$year,$cval->company_id,$bval->id,'bank')); ?></td>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>
                            <td><?php echo e(number_format(calcualte_ot_total_earning_by_month_company($month,$year,$cval->company_id,$bval->id,'','total'), 2)); ?></td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endif; ?>
                <tr>
                    ...
                    <?php if(isset($emp_company_data) && count($emp_company_data) > 0): ?>
                        <?php $__currentLoopData = $emp_company_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ckey => $cval): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <td><?php echo e(number_format(calcualte_ot_total_by_month_company($month,$year,$cval->company_id,'cash'), 2)); ?></td>
                            <td><?php echo e(number_format(calcualte_ot_total_by_month_company($month,$year,$cval->company_id,'bank'), 2)); ?></td>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
                    <td></td>
                </tr>
