                        ...
                        <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                            <div class="profile-widget">
                                <div class="profile-img">
                                    <a href="<?php echo e('/employeeProfileUpdate?id='.$employee->id); ?>" class="avatar">
                                        <img src="<?php echo e(($employee->profile!=null)?'uploads/profile/'.$employee->profile:'assets/img/profiles/avatar.png'); ?>" alt=""></a>
                                </div>
                                <div class="dropdown profile-action">
                                    <a href="#" class="action-icon dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item" href="<?php echo e('/employeeProfileUpdate?id='.$employee->id); ?>" ><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                        <a class="dropdown-item deleteButton" href="#" data-bs-toggle="modal" data-bs-target="#delete_employee" data-data="<?php echo e($employee->id); ?>"><i class="fa fa-trash-o m-r-5" ></i> Delete</a>
                                    </div>
                                </div>
                                <h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="<?php echo e('/employeeProfileUpdate?id='.$employee->id); ?>"><?php echo e(ucfirst($employee->first_name)); ?><small>(<?php echo e($employee->emp_generated_id); ?>)</small></a>
                                <?php echo ($employee->status=='inactive')?'<span class="badge bg-inverse-danger">Resigned</span>':'<span class="badge bg-inverse-success">Active</span>'; ?></h4>
                                ...
                                <?php echo e($employee->employee_designation?ucfirst($employee->employee_designation->name):''); ?>
                                ...
                                <div class="row">
                                   ...
                                   <div class="col-sm-6">  
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" readonly name="emp_generated_id" id="emp_generated_id" value="<?php echo $auto_id;?>">
                                        </div>
        ...
        $("#addemployee").validate({
            rules: {
                ...
                user_name: {
                    ...
                    remote: {
                        type: 'post',
                        url: "<?php echo e(route('isUsernameExists')); ?>",
                        data :{
                ...
                email: {
                    ...
                    remote: {
                        type: 'post',
                        url: "<?php echo e(route('isEmailExists')); ?>",
                        data :{
                            "_token": "<?php echo e(csrf_token()); ?>",
                            'branch': function () {
                                return $('#email').val();
                ...
                emp_generated_id: {
                    ...
                    remote: {
                        type: 'post',
                        url: "<?php echo e(route('isEmployeeIdExists')); ?>",
                        data :{
                            "_token": "<?php echo e(csrf_token()); ?>",
                            'branch': function () {
...
</script><?php /**PATH C:\xampp81\htdocs\hrmumair\resources\views/edbr/employee.blade.php ENDPATH**/ ?>