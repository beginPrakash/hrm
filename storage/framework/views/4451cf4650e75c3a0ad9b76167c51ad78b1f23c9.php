                                    ...
                                    <div class="col-md-5">
                                        <div class="profile-info-left">
                                            <h3 class="user-name m-t-0 mb-0"><?php echo e($user->first_name ? ucfirst($user->first_name).' '.ucfirst($user->last_name)  : "--"); ?>
                                                ...
                                                <?php echo ($user->status=='inactive')?'<span class="badge bg-inverse-danger">Resigned</span>':'<span class="badge bg-inverse-success">Active</span>'; ?>
                                            </h3>
                                            ...
                                            <small class="text-muted"><?php echo e($user->employee_company ? $user->employee_company->company_name : ""); ?></small>
                                            ...
                                            <div class="small doj text-muted">Date of Join : <?php echo e($user->joining_date ? $user->joining_date : "--"); ?></div>
                                        ...
                                        <div class="col-md-7">
                                            ...
                                            <li>
                                                ...
                                                <div class="text"><?php echo e($user->employee_details ? $user->employee_details->birthday  : "--"); ?></div>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                ...
                                                <div class="text"><?php echo e($user->employee_details ? $user->employee_details->gender  : "--"); ?></div>
                                            </li>
                                            <li>
                                                <div class="title"></div>
                                                <div class="text">
                            ...
                            <div class="card-body">
                                ...
                                <ul class="personal-info">
                                    ...
                                    <li>
                                        ...
                                        <div class="text"><?php echo e($user->passport_expiry ? date('d/m/Y', strtotime($user->passport_expiry)) : "--"); ?></div>
                                    </li>
                                    
                                    <li>
                                        <div class="title">Address</div>
                                        <div class="text"><?php echo e((isset($user->employee_details->pi_address)) ? $user->employee_details->pi_address : "--"); ?></div>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <small class="block text-ellipsis">
                                                            <span class="text-muted">Uploaded on : <?php echo date('dS F Y', strtotime($edoc->created_at)); ?></span>
                                                        </small>
                                                    </td>
                                                    <td>
                            ...
                            <div class="card-body">
                                ...
                                <ul class="personal-info salary-info">
                                    <li>
                                        ...
                                        <div class="text"><?php echo e($user->employee_salary ?$fy_array[$user->employee_salary->financal_year] : '--'); ?></div>
                                    </li>
                                    <li>
                                        <div class="title">Basic Salary</div>
                                        <div class="text"><?php echo e($user->employee_salary ?'₹ '.number_format($user->employee_salary->basic_salary,2) : '--'); ?></div>
                                    </li>
                                    <li>
                                        <div class="title">Travel Allowance</div>
                                        <div class="text"><?php echo e($user->employee_salary ?'₹ '.number_format($user->employee_salary->travel_allowance,2):'--'); ?></div>
                                    </li>
                                    <li>
                                        <div class="title">Food Allowance </div>
                                        <div class="text"><?php echo e($user->employee_salary ?'₹ '.number_format($user->employee_salary->food_allowance,2) : '--'); ?></div>
                                    </li>
                                    <li>
                                        <div class="title">House Allowance</div>
                                        <div class="text"><?php echo e($user->employee_salary ?'₹ '.number_format($user->employee_salary->house_allowance,2):'--'); ?></div>
                                    </li>
                                    <li>
                                        <div class="title">Position Allowance </div>
                                        <div class="text"><?php echo e($user->employee_salary ?'₹ '.number_format($user->employee_salary->position_allowance,2) : '--'); ?></div>
                                    </li>
                                    <li>
                                        <div class="title">Phone Allowance</div>
                                        <div class="text"><?php echo e($user->employee_salary ?'₹ '.number_format($user->employee_salary->phone_allowance,2):'--'); ?></div>
                                    </li>
                                    <li>
                                        <div class="title">Other Allowance </div>
                                        <div class="text"><?php echo e($user->employee_salary ?'₹ '.number_format($user->employee_salary->other_allowance,2) : '--'); ?></div>
                                    </li>
                                    <li>
                                        <div class="title">Total Salary</div>
                                        <div class="text"><?php echo e($user->employee_salary ?'₹ '.number_format($user->employee_salary->total_salary,2) : '--'); ?></div>
                                    </li>
                                </ul>
                    ...
                    <div class="col-md-6 d-flex">
                        <div class="card profile-box flex-fill">
                            <div class="card-body">
                                ...
                                $pendingAmt = (isset($user->employee_loan->loan_amount))?$user->employee_loan->loan_amount-$paid:0; 
                                $pendingEmiCount = (isset($user->employee_loan->installment))?$user->employee_loan->installment-$emiCount:0; 
                                ?>
                                ...
                                <ul class="personal-info">
                                    <li>
                                        ...
                                        <div class="text"><?php echo e($user->employee_loan ? $user->employee_loan->loan_amount : '--'); ?></div>
                                    </li>
                                    <li>
                                        <div class="title">Date .</div>
                                        <div class="text"><?php echo e($user->employee_loan ? $user->employee_loan->loan_date:'--'); ?></div>
                                    </li>
                                    
                                    <li>
                                        <div class="title">Installments</div>
                                        <div class="text"><?php echo e($user->employee_loan ? ($user->employee_loan->installment ?$user->employee_loan->installment:'--'):'--'); ?></div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="text"><?php echo e($pendingEmiCount); ?></div>
                                    </li>
                                            ...
                                            <Hr/>
                                                ...
                                                <?php if(!empty($salaryDetails)){ ?>
                                                    <li>
                                                        ...
                                                        <div class="text"><?php echo (isset($salaryDetails->total_work_hours))?$salaryDetails->total_work_hours:''; ?></div>
                                                    </li>

                                                    <li>
                                                        <div class="title">Total Deductions</div>
                                                        <div class="text"><?php echo (isset($salaryDetails->deductions))?number_format($salaryDetails->deductions,2):''; ?></div>
                                                    </li>

                                                    <li>
                                                        <div class="title">Total Additions</div>
                                                        <div class="text"><?php echo (isset($salaryDetails->additions))?number_format($salaryDetails->additions,2):''; ?></div>
                                                    </li>

                                                    <li>
                                                        <div class="title">Total Salary</div>
                                                        <div class="text"><?php echo (isset($salaryDetails->total_salary))?number_format($salaryDetails->total_salary,2):''; ?></div>
                                                    </li>
                                                ...
                                                <?php if(!empty($indemnityDetails) && count($indemnityDetails) > 0){ ?>
                                                    <Hr/>
                                                    <h4>Indemnity Information</h4>
                                                    <Hr/>
                                                    <li>
                                                        <div class="title">Last W.Day</div>
                                                        <div class="text"><?php echo (!empty($indemnityDetails) && isset($indemnityDetails[0]->today_date))?date('d-m-Y', strtotime($indemnityDetails[0]->today_date)):''; ?></div>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="text"><?php echo (!empty($indemnityDetails) && (isset($indemnityDetails[0]->years_diff)))?$indemnityDetails[0]->years_diff:''; ?></div>
                                                    </li>

                                                    <li>
                                                        <div class="title">Total Indemnity</div>
                                                        <div class="text">KWD <?php echo (!empty($indemnityDetails))?number_format(array_sum(array_column($indemnityDetails->toArray(),'total_amount')),2):''; ?></div>
                                                    </li>
                                                    <table class="table">
                                                        <tr>
                                                            <th>Salary/day</th>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $indem->indemnity_perc; ?></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>KWD <?php echo (!empty($indemnityDetails))?number_format(array_sum(array_column($indemnityDetails->toArray(),'total_amount')),2):''; ?></th>
                                                    </tr>
                                                    </table>
                                                <?php } ?>
                                                </ul>
                    ...
                    <div class="tab-pane fade" id="annual_leave">
                        <div class="row">
                            <div class="col-md-8 d-flex">
                                <div class="card profile-box flex-fill">
                                    <div class="card-body">
                                        <h3 class="card-title">Vaccation Management <?php //echo date('Y'); ?><a href="#" class="edit-icon" data-bs-toggle="modal" data-bs-target="#opening_leave_info_modal"><i class="fa fa-pencil"></i></a></h3>
                                        <div class="row">
                                            <ul class="personal-info">
                                                <Hr/>
                                                ...
                                                $joining_date = (isset($user->joining_date)) ? $user->joining_date : $todaydate;
                                                ...
                                                // echo $user->opening_leave_days;
                                                $totalLeaveDays = $totalLeaveMonths * 2.5;
                                                $balance = (!empty($user) && (isset($user->opening_leave_days)))?$user->opening_leave_days:0;
                                                $used = ($balance != 0)?$totalLeaveDays - $balance:0;
                                                $leaveBalance = $totalLeaveDays - $used;
                                                $sal = (isset($user->employee_salary->total_salary))?$user->employee_salary->total_salary:0;
                                                $perday = $sal / 26;
                                                $leaveAmount = $perday * $leaveBalance;
                                                ?>
                                                <li>
                                                    <div class="title">Total Leave Days</div>
                                                    <div class="text"><?php echo $totalLeaveDays; ?></div>
                                                </li>
                                                <li>
                                                    <div class="title">Used Leave Days</div>
                                                    <div class="text"><?php echo $used; ?></div>
                                                </li>
                                                <li>
                                                    <div class="title">Leave Balance Days</div>
                                                    <div class="text"><?php echo $leaveBalance; ?></div>
                                                </li>
                                                <li>
                                                    <div class="title">Leave Balance Amount</div>
                                                    <div class="text">KWD <?php echo number_format($leaveAmount, 2); ?></div>
                                                </li>
            ...
            <!-- name -->                                
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="cal-icon">
                                                <input class="form-control datetimepicker" type="text" value="<?php echo e($user->employee_details ? $user->employee_details->birthday  : ''); ?>" name="birthday">
                                            </div>
                                        </div>
                                    </div>
                                     <div class="col-md-6">
                         ...
                         <div class="row">
                            ...
                            <div class="col-md-6">
                             ...
                             <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="cal-icon">
                                                <input class="form-control datetimepicker" type="text" value="<?php echo e($user->joining_date ? $user->joining_date : ''); ?>" name="joining_date">
                                            </div>
                                        </div>
                                    </div>
                            <HR>
                            ...
                            <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="cal-icon">
                                                <input class="form-control datetimepicker" type="text"  value="<?php echo e($user->employee_details? $user->employee_details->expi_c_id : ''); ?>" name="expi_c_id">
                                            </div>
                                        </div>
                                    </div>
                            <div class="col-md-6">
                             ...
                             <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="cal-icon">
                                                <input class="form-control datetimepicker" type="text"  value="<?php echo e($user->employee_details ? $user->employee_details->expi_b_id: ''); ?>" name="expi_b_id">
                                            </div>
                                        </div>
                                    </div>
                             <div class="col-md-6">
                          ...
                          <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="cal-icon">
                                                <input class="form-control datetimepicker" type="text"  value="<?php echo e($user->employee_details ? $user->employee_details->license_exp: ''); ?>" name="license_exp">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="select form-control" name="financial_year" >
                                        <option value="1" <?php echo e($user->employee_salary ? ($user->employee_salary->financal_year == '1' ? 'selected' :'' ) : ''); ?>>April 2022-March 2023</option>
                                        <option value="2" <?php echo e($user->employee_salary ? ($user->employee_salary->financal_year == '2' ? 'selected' :'' ) : ''); ?>>April 2023-March 2024</option>
                                        <option value="3" <?php echo e($user->employee_salary ? ($user->employee_salary->financal_year == '3' ? 'selected' :'' ) : ''); ?>>April 2024-March 2025</option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="cal-icon">
                                        <input class="form-control datetimepicker"  name="pass_expiry"  type="text" value="<?php echo e($user->passport_expiry ? date('d/m/Y', strtotime($user->passport_expiry)) : ''); ?>">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group form-focus focused">
                                                <div class="cal-icon">
                                                    <input type="text"  class="form-control floating datetimepicker" name="started[]" value="<?php echo e(date('d/m/Y',strtotime($education_value->start))); ?>">
                                                </div>
...
</script><?php /**PATH C:\xampp81\htdocs\hrmumair\resources\views/edbr/profile.blade.php ENDPATH**/ ?>