                    ...
                    @if(isset($data_list) && count($data_list) > 0)
                        ...
                        @foreach($data_list as $key => $data)
                            ...
                            <tr>
                                ...
                                <td>
                                    <p>{{(isset($data->branch_details) && !empty($data->branch_details)) ? $data->branch_details->name : ''}}</p> 
                                </td>
                                <td>
                                    <p>{{(isset($data->regis_type) && !empty($data->regis_type)) ? $data->regis_type->name : ''}}</p>
                                </td>
                                <td>
                                    <p>{{(isset($data->company_details) && !empty($data->company_details)) ? $data->company_details->name : ''}}</p>
                                </td>
                                <td>
                                    <p></p>
                                </td>
                                <td>
                                    <p>KWD {{number_format($company_cost,2) ?? 0}}</p>
                                </td>
                                <td>
                            ...
                            @if(isset($com_list) && count($com_list) > 0)
                                ...
                                $sum = $sum +$cost_sum; @endphp
                                    <tr>                       
                                        ...
                                        <td colspna="1">
                                            <p align="center">{{_get_company_name($val->company_id)}}</p>
                                        </td>
                                        <td colspan = "3">
