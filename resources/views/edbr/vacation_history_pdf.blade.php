            ...
            <table class="custom-table" style="margin-bottom: 30px;max-width:400px;">
                ...
                <tbody>
                        @if(isset($leave_data) && !empty($leave_data))   
                            @if(!empty($leave_data->leave_days)) 
                                <tr>
                                    <td>
                                        <p>Annual Leave</p>
                                    </td>
                                    <td>
                                        <p>{{$leave_data->claimed_annual_days_rem + $leave_data->claimed_annual_days}} Days</p>
                                    </td>
                                    <td>
                                        <p>Yes</p>
                                    </td>
                                    <td>
                                        <p>{{$leave_data->claimed_annual_days}} Days</p>
                                    </td>
                                </tr>
                                @if(!empty($leave_data->claimed_public_days)) 
                                    <tr>
                                        <td>
                                            <p>Public Holiday</p>
                                        </td>
                                        <td>
                                            <p>{{$leave_data->claimed_public_days_rem + $leave_data->claimed_public_days}} Days</p>
                                        </td>
                                        <td>
                                            <p>Yes</p>
                                        </td>
                                        <td>
                                            <p>{{$leave_data->claimed_public_days}} Days</p>
                                        </td>
                                    </tr>
                                @endif
                            @endif
