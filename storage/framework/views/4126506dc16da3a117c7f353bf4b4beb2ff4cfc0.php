                    ...
                    <div class="profile-widget">
                        <div class="profile-img">
                            <a href="<?php echo e(route('company.detail',$val->id)); ?>" class="avatar">
                                <img src="<?php echo e(($val->logo!=null)?'uploads/transportation/'.$val->logo:'assets/img/profiles/avatar.png'); ?>" alt=""></a>
                        </div>
                        ...
                        <h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="<?php echo e(route('company.detail',$val->id)); ?>"><?php echo e(ucfirst($val->car_name)); ?></a>
                        </h4>
