                    ...
                    <div class="table-responsive">
                        <table class="table table-striped custom-table datatablex" id="datatable">
                            ...
                            <tbody>
                            	...
                            	{
                            		foreach($salaryDetails as $sal)
                            		{ 
                                        // if($sal->employees->status==='deleted')
                                        // {
                                        //     continue;
                                        // }
                                ...
                                <tr>
                                    ...
                                    <td><?php echo ($sal->employees->joining_date!=NULL)?date('d F, Y', strtotime($sal->employees->joining_date)):''; ?></td>
                                    ...
                                    <td><?php echo (isset($sal->total_salary))?$sal->total_salary:0; ?></td>
                                    <!-- <td><?php //echo $sal->total_overtime_salary; ?></td> -->
                                    <td>
                                        <?php if((isset($sal->total_salary)) && $sal->total_salary > 0){ ?>
                                            <a class="btn btn-sm btn-primary" href="/generate-salary-slip/<?php echo $sal->id; ?>">Generate Slip</a>
                                        <?php } ?>
                                    </td>
...
</script><?php /**PATH /home/eqb1fxfgkdl8/public_html/hrm/resources/views/payroll/employee_salary.blade.php ENDPATH**/ ?>