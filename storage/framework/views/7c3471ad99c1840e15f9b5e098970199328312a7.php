...
<!-- Ck Editor -->
<link rel="stylesheet" href="<?php echo e(asset('assets/css/ckeditor.css')); ?>">
...
<div class="header-left">
     <a href="<?php echo e(route('dashboard')); ?>" class="logo">
        <img src="<?php echo e(asset('assets/img/logo1.png')); ?>" width="40" height="40" alt="">
    </a>
...
<!-- /Logo -->
			    ...
			    <ul class="nav user-menu">
			        ...
			        <li class="nav-item dropdown has-arrow flag-nav">
			            ...
			            <div class="dropdown-menu dropdown-menu-right">
			                ...
			                <a href="javascript:void(0);" class="dropdown-item">
			                    <img src="<?php echo e(asset('assets/img/flags/Kw.png')); ?>" alt="" height="16"> Arabic
			                </a>
			        ...
			        <li class="nav-item dropdown has-arrow main-drop">
			            <a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
			                <span class="user-img"><img src="<?php echo e(asset('assets/img/profiles/avatar-21.jpg')); ?>" alt="">
			...
			<!-- /Header --><?php /**PATH C:\wamp64_new\www\hrm\resources\views/includes/header.blade.php ENDPATH**/ ?>