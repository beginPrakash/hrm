...
<!-- Multiselect JS -->
	<script src="<?php echo e(asset('assets/js/multiselect.min.js')); ?>"></script>

	<?php } if ($page == 'client-profile' || $page == 'project-view.php' || $page == 'tasks.php') { ?>
<!-- Task JS -->
	<script src="<?php echo e(asset('assets/js/task.js')); ?>"></script>
...
<!-- Custom JS -->
	...
	<?php echo $__env->make('includes/custom_js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH C:\wamp64_new\www\hrm\resources\views/includes/footer.blade.php ENDPATH**/ ?>