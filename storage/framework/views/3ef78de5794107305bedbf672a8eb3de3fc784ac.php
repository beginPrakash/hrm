...
<div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="<?php echo e(route('user_selling_period.store')); ?>" method="post" id="addForm">
            <?php echo csrf_field(); ?>
...
</div><?php /**PATH C:\wamp64_new\www\hrm\resources\views/user_selling_management/selling_period_modal.blade.php ENDPATH**/ ?>