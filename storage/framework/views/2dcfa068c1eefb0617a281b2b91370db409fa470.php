                        ...
                        <div class="table-responsive">
                            <table class=" table table-bordered table-striped table-hover user_leave_request_tbl <?php if(isset($leaveData) && ($leaveData->leave_type == 1)): ?> <?php else: ?> d-none <?php endif; ?>">
                                ...
                                <tbody>
                                    <tr>
                                        <td>Annual Leave</td>
                                        <td><input type="hidden" value="<?php echo e($leave_details['remaining_leave'] ?? 0); ?>" class="an_avail"><?php echo e($leave_details['remaining_leave'] ?? 0); ?> Days</td>
                                        ...
                                        <?php if(isset($leaveData) && !empty($leaveData)): ?>
                                            ...
                                            <td><input type="number" onkeypress="return digitKeyOnly(event,this)" value="<?php echo e($leaveData->claimed_annual_days ?? 0); ?>" name="annual_leave_days" class="annual_leave_days"  max="<?php echo e($leave_details['remaining_leave'] ?? 0); ?>" min="0" <?php echo e(($leaveData->claimed_annual_days <= 0) ? 'disabled' : ''); ?>></td>
                                        <?php else: ?>
                                            <td>
                                                <div class="form-check form-switch">
                                            ...
                                            <td><input type="number" onkeypress="return digitKeyOnly(event,this)" name="annual_leave_days" class="annual_leave_days"  max="<?php echo e($leave_details['remaining_leave'] ?? 0); ?>" min="0" disabled></td>
                                        <?php endif; ?>
                                        <td class="annual_remaining_leave">
                                            <?php if(isset($leaveData) && !empty($leaveData)): ?>
                                                <?php echo e($leaveData->claimed_annual_days_rem ?? 0); ?> Days
                                            <?php else: ?>
                                                <?php echo e($leave_details['remaining_leave'] ?? 0); ?> Days
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                    <?php if($userdetails[0]->public_holidays_balance > 0): ?>
                                        <tr>
