                ...
                <tbody>
                    ...
                    <?php if(isset($data_list) && count($data_list) > 0): ?>
                        ...
                        <?php $__currentLoopData = $data_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><?php echo e($data->reg_name); ?></p>
                                </td>
                                <td>
                                    <p><?php echo e($data->reg_no); ?></p>
                                </td>
                                <td>
                                    <p><?php echo e((isset($data->branch_details) && !empty($data->branch_details)) ? $data->branch_details->name : ''); ?></p> 
                                </td>
                                <td>
                                    <p><?php echo e((isset($data->regis_type) && !empty($data->regis_type)) ? $data->regis_type->name : ''); ?></p>
                                </td>
                                <td>
                                    <p><?php echo e((isset($data->company_details) && !empty($data->company_details)) ? $data->company_details->name : ''); ?></p>
                                </td>
                                <td>
                                    <p></p>
                                </td>
                                <td>
                                    <p>KWD <?php echo e(number_format($company_cost,2) ?? 0); ?></p>
                                </td>
                                <td>
                    ...
                    <?php $sum = 0; ?>
                            <?php if(isset($com_list) && count($com_list) > 0): ?>
                                ...
                                <?php $cost_sum = _sum_of_companycost($val->ids); 
                                $sum = $sum +$cost_sum; ?>
                                    <tr>                       
                                        <td colspan="6">
                                        ...
                                        <td colspna="1">
                                            <p align="center"><?php echo e(_get_company_name($val->company_id)); ?></p>
                                        </td>
                                        <td colspan = "3">
...
<?php //exit; ?><?php /**PATH C:\wamp64_new\www\hrm\resources\views/reports/company_report_pdf.blade.php ENDPATH**/ ?>