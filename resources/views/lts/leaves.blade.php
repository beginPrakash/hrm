                                        ...
                                        if(isset($leaveApplications))
                                        {
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    if(((isset($userdetails[0]->employee_designation)) && $userdetails[0]->employee_designation->priority_level > 0) || $user->is_admin == 1)
                                                    { ?>
                                                        <td>{{$leave->leave_user->first_name ?? ''}} {{$leave->leave_user->last_name ?? ''}}</td>
                                                    <?php } ?>
                                                    ...
                                                    <?php echo ucwords($leave->leave_status); ?>
                                                        <!-- <div class="dropdown action-label">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <a class="dropdown-item approveButton" href="#" data-bs-toggle="modal" data-bs-target="#approve_leave" data-id="{{$leave->id}}" data-data="<?php echo $leave->id; ?>"><i class="fa fa-dot-circle-o text-success"></i> Approve</a>
                                                                <a class="dropdown-item rejectButton" href="#" data-bs-toggle="modal" data-bs-target="#reject_leave" data-id="{{$leave->id}}" data-data="<?php echo $leave->id; ?>"><i class="fa fa-dot-circle-o text-danger"></i> Reject</a>
                                                            </div>
                            ...
                            <div class="modal-body">
                                <form  action="/leaveInsert" method="post" id="addEditForm">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control remaining_leaves" readonly type="text" name="remaining_leaves" id="remaining_leaves" value="{{$leave_details['remaining_leave'] ?? 0}}">
