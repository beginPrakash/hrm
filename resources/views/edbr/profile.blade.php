                            ...
                            <div class="card-body">
                                ...
                                <ul class="personal-info">
                                    ...
                                    <li>
                                        ...
                                        <div class="text">{{ucfirst($user->hiring_type ?? '--')}}</div>
                                    </li>
                                            ...
                                            <ul class="personal-info">
                                                ...
                                                <?php } ?>
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="text">{{$user->used_leave ?? 0}}</div>
                                                    </li>
                                                    <li>
                                                        ...
                                                        <div class="text">{{$bal_leave ?? 0}}</div>
                                                    </li>
                                                    <li>
                                                   ...
                                                   <li>
                                                    ...
                                                    <li>
                                                        ...
                                                        @endphp
                                                        <div class="text">KWD {{number_format($bal,2)}}</div>
                                                    </li>
                                                    ...
                                                    <div>
                                                        ...
                                                        <table class="table table-bordered">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td><strong>Total Annual Leave</strong> <span class="float-end">KWD {{number_format(_calculate_salary_by_days($e_sal,$bal_leave ?? 0),2)}}</span></td>
                                                                </tr>
                                                                <tr>
                                                                    <td><strong>Total Public Holiday</strong> <span class="float-end">KWD {{number_format($bal,2)}}</span></td>
                                                                </tr>
                                                                <tr>
                                            ...
                                            <div class="">
                                                <ul class="personal-info">
                                                    ...
                                                    <li>
                                                        <div class="title">Balance Amount</div>
                                                        <div class="text"> 
                                                            @php $e_sal = (isset($user->employee_salary) && !empty($user->employee_salary)) ? $user->employee_salary->basic_salary : 0; @endphp
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="select form-control {{$user->employee_details ? 'selected' : ''}}" name="hiring_type" >
                                        <option value="">Select Hiring Type</option>
                                        <option value="local" {{(isset($user) && ($user->hiring_type == 'local')) ? 'selected' : ''}}>Local</option>
                                        <option value="oversease" {{(isset($user) && ($user->hiring_type == 'oversease')) ? 'selected' : ''}}>Oversease</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
       <form action = "{{route('download_fnf_pdf')}}" method="POST">
        @csrf
