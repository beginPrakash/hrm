        ...
        <div class="modal-body">
            <form  action="<?php echo e(url('store_bonus')); ?>" method="post" id="addEditForm">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="title" id="title" value="<?php echo e($bonusData->title ?? ''); ?>">
                </div>
                <div class="form-group">
                    <label>Remarks <span class="text-danger">*</span></label>
                    <textarea rows="4" class="form-control" name="remarks" id="remarks"><?php echo e($bonusData->remarks ?? ''); ?></textarea>
                </div>
