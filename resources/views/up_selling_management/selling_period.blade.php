...
<div class="page-wrapper">
                                        ...
                                        <td>
                                            <div class="pull-right begin_actions">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox" role="switch" data-url="{{route('up_selling_period.statuschange',array($val->id,$val->is_show ?? 0))}}" id="flexSwitchCheckChecked" {{(!empty($val->is_show)) ? 'checked' : ''}}>
                                                </div>
                                                <div class="">
    ...
    <div id="add_Form" class="modal custom-modal fade" role="dialog">
        @include('up_selling_management/selling_period_modal')
    </div>
    <!-- /Add Selling Period Modal -->
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="modal-btn delete-action">
                        <div class="row">
                            <div class="col-6">
                              <form action="{{route('up_selling_period.delete')}}" method="post">
                                    @csrf
...
<script type="text/javascript">
    ...
    $(document).on('click','.edit_branch',function(){
        ...
        $.ajax({
           url: "{{route('getusersellingdetaiById')}}",
           type: "POST",
           dataType: "json",
