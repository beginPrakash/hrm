...
<div class="page-wrapper">
    ...
    <?php echo $__env->make('flash-message', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>  
            ...
            <div class="row filter-row">
                <div class="col-sm-6 col-md-3">  
                    <div class="form-group form-focus">
                        <input type="text" class="form-control floating" name="car_name" value="<?php echo e($search['car_name'] ?? ''); ?>">
        ...
        <div class="row staff-grid-row pt-4">
            <?php if(isset($transp_list) && count($transp_list) > 0): ?>
                <?php $__currentLoopData = $transp_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="profile-widget">
                        ...
                        <div class="dropdown profile-action">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item edit_trans_btn" href="<?php echo e(route('transportation.detail',$val->id)); ?>"> <i class="fa fa-pencil m-r-5"></i> Edit</a>
                                <a class="dropdown-item deleteButton" href="#" data-bs-toggle="modal" data-bs-target="#delete_transpo" data-id="<?php echo e($val->id); ?>"><i class="fa fa-trash-o m-r-5" ></i> Delete</a>
                            </div>
                        </div>
                        <h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="<?php echo e(route('transportation.detail',$val->id)); ?>"><?php echo e(ucfirst($val->car_name)); ?></a>
                        </h4>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="modal-btn delete-action">
                        <div class="row">
                            <div class="col-6">
                            <form action="<?php echo e(route('transportation.delete')); ?>" method="post">
                                        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\wamp64_new\www\hrm\resources\views/transportation/index.blade.php ENDPATH**/ ?>