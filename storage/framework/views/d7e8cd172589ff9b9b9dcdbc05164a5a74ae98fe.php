                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h2 class="table-avatar">
                                                                <a href="<?php echo e('/employeeProfileUpdate?id='.$sh->id ?? ''); ?>" class="avatar"><img alt="" src="<?php echo $image; ?>"></a>
                                                                <a href="<?php echo e('/employeeProfileUpdate?id='.$sh->id ?? ''); ?>"><?php echo $sh->first_name; ?> <?php echo (isset($sh->last_name))?$sh->last_name:''; ?> <span><em>
                                                                    : 
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="add_schedule_form" action="/scheduleInsert" method="post" class="add_sch_form">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="row" id="timedivadd">
                                    <div class="col-md-4">
                                        <div class="form-group" >
                                            ...
                                            <div class="cal-icon">
                                                <input type="text" class="form-control datewithtime" id="min_start_time" name="min_start_time">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="cal-icon">
                                                <input type="text" class="form-control datewithtime" name="start_time" id="start_time">
                                            </div>                                  
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="cal-icon">
                                                <input type="text" class="form-control datewithtime" name="end_time" id="end_time">
                                            </div>                                  
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="cal-icon">
                                                <input type="text" class="form-control datewithtime" name="max_end_time" id="max_end_time">
                                            </div>                                          
                                        </div>
                                    </div>  
                                    <div class="col-md-4">
            ...
            <div id="edit_schedule" class="modal custom-modal fade" role="dialog">
                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="add_schedule_form" action="/scheduleUpdate" method="post" class="edit_sch_form">
                                <?php echo csrf_field(); ?>
...
</script><?php /**PATH C:\wamp64_new\www\hrm\resources\views/lts/scheduling.blade.php ENDPATH**/ ?>