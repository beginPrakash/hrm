...
<div class="page-wrapper">
    ...
    <div class="content container-fluid">
                        ...
                        <div class="profile-view">
                            <div class="profile-img-wrap">
                                <div class="profile-img">
                                    <a href="#"><img alt="" src="{{ ($trans_detail->logo!=null)? asset('uploads/logo/'.$trans_detail->logo):asset('assets/img/profiles/avatar.png')}}"></a>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="profile-info-left">
                                            <h3 class="user-name m-t-0 mb-0">{{$trans_detail->car_name}}
                                    ...
                                    @if(isset($documents) && count($documents) > 0)
                                        ...
                                        <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3 m-ht-3">
                                            <div class="profile-widget">
                                                ...
                                                <h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="{{route('company.detail',$val->id)}}">{{ ucfirst($val->doc_name) }}</a>
                                                </h4>
        ...
        <div id="add_document" class="modal custom-modal fade " role="dialog">
            @include('transportation/document_modal')
        </div>
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <div class="modal-btn delete-action">
                            <div class="row">
                                <div class="col-6">
                                <form action="{{route('transdoc.delete')}}" method="post">
                                            @csrf
...
<script>
   $(document).on('click','.edit_trans_btn',function(){
    ...
    $(document).on('click','.edit_doc_btn',function(){
        ...
        var id= $(this).attr('data-id');
        $.ajax({
        url: "{{route('gettransdocumentDetailsById')}}",
        type: "POST",
        dataType: "json",
        data: {"_token": "{{ csrf_token() }}", id:id},
        success:function(response)
