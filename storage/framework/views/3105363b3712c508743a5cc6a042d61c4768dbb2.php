...
<div class="page-wrapper">
                                        ...
                                        <td>
                                            <div class="pull-right begin_actions">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox" role="switch" data-url="<?php echo e(route('up_selling_period.statuschange',array($val->id,$val->is_show ?? 0))); ?>" id="flexSwitchCheckChecked" <?php echo e((!empty($val->is_show)) ? 'checked' : ''); ?>>
                                                </div>
                                                <div class="">
    ...
    <div id="add_Form" class="modal custom-modal fade" role="dialog">
        <?php echo $__env->make('up_selling_management/selling_period_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
    <!-- /Add Selling Period Modal -->
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="modal-btn delete-action">
                        <div class="row">
                            <div class="col-6">
                              <form action="<?php echo e(route('up_selling_period.delete')); ?>" method="post">
                                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\wamp64_new\www\hrm\resources\views/up_selling_management/selling_period.blade.php ENDPATH**/ ?>