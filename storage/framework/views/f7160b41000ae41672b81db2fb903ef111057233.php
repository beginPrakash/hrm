                ...
                <tbody>
                    ...
                    <?php if(isset($data_list) && count($data_list) > 0): ?>
                        ...
                        <?php $__currentLoopData = $data_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p><?php echo e((isset($data->employee_details) && !empty($data->employee_details->expi_c_id)) ? date('d, M Y', strtotime($data->employee_details->expi_c_id)) : ''); ?></p>
                                </td>
                                <td>
                                ...
                                <td>
                                    <p>KWD <?php echo e($civil_cost ?? 0); ?></p>
                                </td>
                                <td>
                    ...
                    <?php $sum = 0; ?>
                            <?php if(isset($com_list) && count($com_list) > 0): ?>
                                ...
                                <?php $cost_sum = _sum_of_empcost($val->ids,'civil_cost'); 
                                $sum = $sum +$cost_sum; ?>
                                    <tr>                       
                                        <td colspan="8">
...
<?php //exit; ?><?php /**PATH C:\wamp64_new\www\hrm\resources\views/reports/civil_report_pdf.blade.php ENDPATH**/ ?>